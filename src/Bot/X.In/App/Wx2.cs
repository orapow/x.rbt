...
namespace Rbt.Svr.App
{
    public class Wx2
    {
        ...
        #region 公开事件
        public delegate void LoadQrHandler(Wx2 w);
        public event LoadQrHandler LoadQr;

        public delegate void ScanedHandler(Wx2 w);
        public event ScanedHandler Scaned;

        public delegate void LogedHandler(Wx2 w);
        public event LogedHandler Loged;

        public delegate void LogoutHandler(Wx2 w);
